                ...
                <div class="card-body">
                    <div class="text-right">
                        <a href="{{ route('portfolios.create') }}">
                            <button type="button" class="btn btn-primary mb-2 text-right">Create Portfolio</button>
                        </a>
                    </div>
        ...
        function deleteConfirmation(id) {
            swal.fire({
                ...
                if (e.value === true) {
                    ...
                    $.ajax({
                        type: 'DELETE',
                        url: "{{ route('portfolios.destroy','_id') }}".replace('_id', id),
                        ...
                        success: function (results) {
                            ...
                            if (results.success === true) {
                                swal.fire("Successfully deleted", results.message, "success").then(function() {
                                    window.location = "{{ route('portfolios.index') }}";
                                });
                            } else {
